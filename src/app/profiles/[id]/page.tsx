        ...
        <div className="bg-neutral-900 rounded-lg p-4">
          ...
          <ProfileForm
            initialValues={{
              ...
              cellDesignation: profile.cellDesignation ?? '',
              cellConfiguration: profile.cellConfiguration ?? '',
              nominalVoltageV: profile.nominalVoltageV,
              nominalCapacityMah: profile.nominalCapacityMah,
              batteryFormFactor: profile.batteryFormFactor ?? '',
              replaceable: profile.replaceable,
              maxChargeCurrentA: profile.maxChargeCurrentA,
              maxChargeVoltageV: profile.maxChargeVoltageV,
              chargeTempMinC: profile.chargeTempMinC,
              ...
              endOfLifeCapacityPct: profile.endOfLifeCapacityPct,
              warrantyUntil: profile.warrantyUntil ?? '',
              warrantyCycles: profile.warrantyCycles,
              notes: profile.notes ?? '',
            }}
